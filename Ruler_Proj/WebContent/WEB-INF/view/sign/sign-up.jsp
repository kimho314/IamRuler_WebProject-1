    ...
    <div id="wrapper">
      <div id="main">
        <div class="inner">
            ...
            <form method="POST">
              <table class="회원가입테이블">
                ...
                <tr>
                  ...
                  <td>
                    <div class="select-wrapper">
                      <select name="체형" id="체형" alr="남성">
                        <option value="1">보통</option>
                        <option value="2">작은 역삼각</option>
                        <option value="3">큰 사각</option>
                        <option value="4">사각</option>
                      </select>
                    </div>
                    <div class="select-wrapper">
                      <select name="체형" id="체형" alr="여성">
                        <option value="1">보통</option>
                        <option value="2">작은 역삼각</option>
                        <option value="3">큰 역삼각</option>
                        <option value="4">사각</option>
                      </select>
                    </div>
                  </td>
          ...
          <section>
            <span id="확인버튼">
              <label class="button special" for="open-pop">확인</label>
            </span>
          </section>
        </div>
      </div>
