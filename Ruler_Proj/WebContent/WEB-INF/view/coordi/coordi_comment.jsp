					...
					<div class="content">
						<div class="visual-wrapper">
							<div class="visual-top-coordi-comment">
								<div class="visual-top-left">
									<a href="#" class="button special small">본문 쓰기</a>
								</div>
						...
						<div class="coordi-comment-reg-wrapper box">
							<div class="coordi-comment-reg-icons">
								<ul>
									<li>댓글 작성</li>
									<li><input type="checkbox" id="demo-copy" name="demo-copy"><label for="demo-copy">비공개</label></li>
								</ul>
							</div>
							<div class="coordi-comment-content">
								<div class="coordi-comment-content-left">
									<textarea name="demo-message" id="demo-message" placeholder="댓글을 입력해주세요" rows="6"></textarea>
								</div>
