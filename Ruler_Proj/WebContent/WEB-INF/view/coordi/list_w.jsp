						...
						<div class="visual-wrapper">
							<div class="visual-top">
								<div class="visual-top-left">
									<a href="list_w?p=${param.p }&g=${param.g}&b=${param.b}" class="button special small">여성</a> 
								...
								<div>
									<c:choose>
										<c:when test="${param.b eq '역삼각' }">
											<a href="list_w?p=1&g=여성&b=역삼각" class="button special">역삼각</a>
										</c:when>
										<c:otherwise>
								...
								<div>
									<c:choose>
										<c:when test="${param.b eq '사각' }">
											<a href="list_w?p=1&g=여성&b=사각" class="button special">사각</a>
										</c:when>
										<c:otherwise>
						...
						<ul class="coordi-list-page ">
							...
							<c:forEach var="i" begin="${startNum }" end="${(startNum+4 >= lastNum)?lastNum:(startNum+4) }">
								<c:choose>
									<c:when test="${param.p == i }">
										<li><a href="list_w?p=${i }&g=${param.g}&b=${param.b}" class="page active">${i }</a></li>
									</c:when>									
									<c:otherwise>
										<li><a href="list_w?p=${i }&g=${param.g}&b=${param.b}" class="page">${i }</a></li>
									</c:otherwise>
								</c:choose>								
							</c:forEach>
							...
							<li>
								<c:choose>
									...
									<c:otherwise>
										<a href="list_w?p=${startNum+5 }&g=${param.g}&b=${param.b}"  class="button">Next</a>
									</c:otherwise>
								</c:choose>								
							</li>
						</ul>
