                ...
                <section id="banner">
                    <div class="content">
                            ...
                            <div class="visual-top-coordi-post">
                                <div class="visual-top-right">
                                    <a href="#" class="button small"
                                        style="box-shadow: none; font-size:100%; padding: 0 1em;" onclick="openPopUp()">찜하기</a>
                                    <a href="#" class="button small"
                        ...
                        <div class="coordi-post-table-wrapper">
                            <table class="coordi-post-table" style="color:black">
                                ...
                                <tr>
                                    <td>제목</td>
                                    <td colspan="4">
                                        <input readonly type="text" name="coordi-post-table-title" id="demo-name" value=""
                                            placeholder="제목" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">          
                                        ...
                                        <textarea readonly name="demo-message" id="demo-message" placeholder="내용"
                                            rows="6">
                                        </textarea>
                        ...
                        <div class="coordi-post-icons-bottom">
                            <a href="coordi_list_women1.html" class="button">목록</a>
                            <a href="coordi_comment.html" class="button">댓글</a>
                        </div>
                    </div>
                </section>
            </div>
