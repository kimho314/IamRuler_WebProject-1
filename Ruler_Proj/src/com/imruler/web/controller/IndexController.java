...
//			request.setAttribute("user", memberService.get(userName));
//		}
...
//		System.out.println("비교하러옴");
		...
		case "T":
			...
			break;
		case "P":
			cloth = indexDao.pants(x, y, gender, bodyshape, waistWidth, thighWidth, crotchWidth, hemWidth, pantsTotalLength);
			break;
		case "O":
		...
		case "Sk":
			...
			break;
		case "Op":
			cloth = indexDao.onePiece(x, y, gender, bodyshape, shoulderWidth, chestBreadth, sleeveLength, onePieceTotalLength);
			break;
		}
